...
public class Maptest {
	...
	public static void main(String[] args) {
		...
		inventoryMap.put("애플 아이패드 프로",new Inventory("애플 아이패드 프로",캘린더.getTime(),10));
		
		try {
		
		캘린더.set(2016, 캘린더.APRIL, 28);
		inventoryMap.get("삼성 갤럭시S7").setGetDate(캘린더.getTime()); // 출고일
		inventoryMap.get("삼성 갤럭시S7").setGetAmount(10); // 출고 수량
		...
		//만약에 제품이 존재하지 않을 경우 AmountNotEnough 넣고 사용을 할 것인데
